...
public class Game {
    ...
    public Game(Game game) {
        columns = new Column[game.getColumnCount()];
        for (int i = 0; i < game.getColumnCount(); i++) {
            columns[i] = new Column(game.getColumn(i));
        }
    }

    /**
     * Retrieve a certain Column from the game board.
     *
     * @param i The column to retrieve.
     * @return the ith Column if it exists; null otherwise
     */
     ...
     */
    public String validate(Game after) {
