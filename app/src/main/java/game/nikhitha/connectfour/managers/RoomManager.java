...
import game.nikhitha.connectfour.Gamefield;
import game.nikhitha.connectfour.MainActivity;
...
public class RoomManager implements RoomUpdateListener,
    ...
    public void onRealTimeMessageReceived(RealTimeMessage realTimeMessage) {
        ...
        if (buf[1] == -1) {
            ...
            mActivity.mGamefield = Gamefield.newInstance(mActivity.mParticipantName, R.id.button_multiplayer);

            fragmentManager.beginTransaction()
                    .replace(R.id.container, mActivity.mGamefield, MainActivity.FRAGMENT_GAMEFIELD)
                    .show(mActivity.mGamefield)
                    .commit();
        ...
        if (thisScore != -1) {
            ...
            if (mActivity.mGamefield != null) {
                mActivity.mGamefield.nextMove(thisScore);
            }
